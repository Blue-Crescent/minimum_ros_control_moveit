...
if("TRUE" STREQUAL "TRUE")
  set(cougarbot_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/cougarbot)
  set(cougarbot_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(cougarbot_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cougarbot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ubuntu <ubuntu@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'cougarbot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/cougarbot/${idir}'.  Ask the maintainer 'ubuntu <ubuntu@todo.todo>' to fix it.")
    endif()
